...
use crate::renderer::layout::computed_style::{ComputedStyle, DisplayType, FontSize};
use alloc::rc::Rc;
use alloc::rc::Weak;
...
/// Struct representing a layout object.
#[derive(Debug, Clone)]
...
impl LayoutObject {
    ...
    pub fn update_kind(&mut self) {
        match self.node_kind() {
            NodeKind::Document => panic!("should not create a layout object for a Document"),
            NodeKind::Element(_) => {
...
/// Enum representing a kind of LayoutObject.
...
/// Struct representing a position of a LayoutObject.
...
/// Struct representing a size of a LayoutObject.
#[derive(Debug, Copy, Clone, PartialEq)]
...
/// Create a LayoutObject
/// # Parameters
/// - `node`: The node of the layout tree.
/// - `parent_obj`: The parent LayoutObject.
/// - `cssom`: The CSSOM.
/// # Returns
/// - `LayoutObject`: A new LayoutObject, or `None` if the display property is 'none'.
...
/// Find the word wrap point.
/// # Parameters
/// - `line`: The text.
/// - `max_index`: The maximum index to search for a space.
/// # Returns
/// - `usize`: The index for line break.
...
/// # Parameters
/// - `line`: The text.
/// - char_width: The width of a character.
/// # Returns
/// - `Vec<String>`: The lines.
